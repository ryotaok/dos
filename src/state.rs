...
pub struct State {
    ...
    pub energy: Energy, pub energy_cost: f32,
...
//             energy: Energy(self.energy.0), energy_cost: self.energy_cost,
...
impl State {
    pub fn new() -> State {
        State {
            ...
            energy: Energy(0.0), energy_cost: 0.0,
