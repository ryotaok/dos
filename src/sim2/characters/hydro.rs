...
use crate::sim2::fc::{FieldCharacterIndex, SpecialAbility, SkillAbility, CharacterAbility, NoopAbility, NoopSkillAbility, CharacterData, CharacterRecord, Enemy};
...
impl Barbara {
    pub fn record() -> CharacterRecord {
        CharacterRecord::default()
            ...
            // .burst_cd(20.0).energy_cost(80.).burst_dmg(0.0)
            .energy_cost(80.)
    }
