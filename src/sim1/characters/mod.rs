use crate::sim1::fc::{FieldCharacterIndex, CharacterRecord, SpecialAbility, CharacterAbility};
...
mod tests {
    ...
    use crate::sim1::types::Vision;
    use crate::sim1::simulate::simulate;
    use crate::sim1::testutil::{TestEnvironment2, TestCharacter};
    use crate::sim1::fc::NoopAbility;
