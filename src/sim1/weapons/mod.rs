...
use crate::sim1::fc::{FieldCharacterIndex, WeaponRecord, SpecialAbility};
...
mod tests {
    ...
    use crate::sim1::types::{Vision, FieldEnergy};
    use crate::sim1::simulate::simulate;
    use crate::sim1::fc::{CharacterData, FieldAbility};
    use crate::sim1::action::Attack;
